...
class ExportManager:
    ...
    def _export_gemini(self, output: Optional[str], context: Dict[str, Any]) -> str:
        """Export Gemini configuration to JSON format with complete settings."""
        if output is None:
        ...
        # Build comprehensive JSON configuration following Gemini CLI standards
        config = {
