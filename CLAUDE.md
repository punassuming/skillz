...
Skillz is a CLI tool for managing AI assistant skills and slash commands across multiple LLM platforms (OpenCode, Claude Code, Codex, Gemini, GitHub Copilot, MCP). The tool allows users to discover, install, create, and manage reusable skills that extend LLM capabilities.
...
3. Multi-platform support via `platforms` dict in config (opencode, claude, codex, gemini, copilot, mcp)
4. Default platform is OpenCode, but fully supports Claude Code, Codex, Gemini, GitHub Copilot, and MCP
